...
if __name__ == "__main__":
    ...
    print("Half Life: ", half_life * 20 / 60, "Error: ", half_life_error*20/60)
    ...
    plt.plot(x_data * 20 / 60, model_func_2_data, label='Exponential Model regression', linestyle='dashed',
             color='blue')
