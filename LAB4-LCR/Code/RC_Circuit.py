...
if __name__ == '__main__':
    ...
    plot_residual(measured_data, calculated_data, x_axis_data, 0.05, "RC Capacitor voltage Residual", "Time (Seconds)", "Voltage (Volts)")
    plt.show()
    ...
    plot_residual(measured_data2, calculated_data2, x_axis_data2, 0.05, "RC Capacitor voltage Residual (rise)", "Time (Seconds)", "Voltage (Volts)")
    plt.show()
    ...
    #&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
    print()
    draw_data("RC_extra_data_resistor.csv", "RC resistor ex2", "Time (milli-Seconds)", "Voltage (Volts)", ["Resistor data", "curve_fit"], 0.05)
    ...
    plot_residual(measured_data1, calculated_data1, x_axis_data1, 0.05, "RC resistor voltage Residual (rise)", "Time (milli-Seconds)", "Voltage (Volts)")
    plt.show()

    plot_residual(measured_data2, calculated_data2, x_axis_data2, 0.05, "RC resistor voltage Residual (drop)", "Time (milli-Seconds)", "Voltage (Volts)")
    plt.show()
